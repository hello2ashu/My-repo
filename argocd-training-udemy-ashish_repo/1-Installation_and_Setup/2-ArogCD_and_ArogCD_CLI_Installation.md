...
In case you want to access ARGO CD using ingress (fqdn) deploy nginx, certi-manager and create crert issuer before installing argo cd.

## Create nginx Namespace
kubectl create ns nginx

# Deploy nginx
create nginx.yaml and execute kubectl apply -f



# Create cert-manager Namespace
kubectl create ns cert-manager
Create cert-manager.yaml and execute kubectl apply -f

# Create cert-issuer.yaml and apply using kubectl apply -f

# Create ingress.yaml and apply using kubectl apply -f
